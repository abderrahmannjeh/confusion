...
class  Contact extends Component {
    ...
    handleSubmit(values) {
        ...
        this.props.postFeadBack(values.firstname,values.lastname,values.telnum,values.email,values.agre,values.contactType,values.message);
        this.setState({vat :" values"});
